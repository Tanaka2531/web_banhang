...
@section('body')
    <div class="box_btn_search">
        <div class="flex_btn_search">
            ...
            <a href="{{ route('listBrands') }}" class="btn_redirect"><ion-icon name="reload-circle-outline"></ion-icon></a>
        </div>
    </div>
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <div class="flex_options">
                                ...
                                <a class="delete_main" data-id="{{ $v['id'] }}" data-type="brand"><span><ion-icon name="trash-outline"></ion-icon></span></a>
                            </div>
                        </td>
                    <tr>
                @endforeach
