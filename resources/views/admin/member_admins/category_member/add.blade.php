                    ...
                    <div class="card mb-3">
                        ...
                        <div class="card-body">
                            <div class="box_input">
                                ...
                                <input type="text" class="form-control" name="name_role" id="name_role" placeholder="Tên danh mục" value="{{ ($update != NULL) ? $update['name_role']: ''}}">
                                @error('name_role')
                                    <span>{{ $message }}</span>
                                @enderror
                            </div>          
                            <div class="box_check_status">
                                <div class="item_check_status">
                                    ...
                                    <select class="form-select" aria-label="Default select example" name="status_cate_member">            
                                        @if($update != NULL) 
                                            @if($update['status'] == 1)
