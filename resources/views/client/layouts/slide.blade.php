...
<section class="slideshow">
    <div class="slideshow__list swiper swiper-slideshow">
        ...
        <div class="swiper-button custom-swipper-button swiper-slide-prev swiper-button-prev"></div>
        <div class="swiper-button custom-swipper-button swiper-slide-next swiper-button-next"></div>
    </div>
</section>    
@endif
